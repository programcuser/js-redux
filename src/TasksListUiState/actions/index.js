...
export const addTaskTheme = createAction('ADD_TASK_THEME');
export const removeTaskTheme = createAction('REMOVE_TASK_THEME');
export const changeTaskTheme = createAction('CHANGE_TASK_THEME');
